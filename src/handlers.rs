...
/// - `400 Bad Request` — empty batch, mixed-chain batch, or batch larger than `10 × max_concurrent_requests` for the resolved chain.
...
pub async fn handle_status(
    ...
    let limit = state
        ...
        .chains
        .get(&chain_id)
        .map(|c| c.s3.max_concurrent_requests.saturating_mul(10))
